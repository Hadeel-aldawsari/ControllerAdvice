...
public class OfficialProviderController {
    ...
    @PostMapping("/add")
    public ResponseEntity add(@RequestBody @Valid OfficialProvider officialProvider){
    ...
    public ResponseEntity update(@PathVariable Integer id, @RequestBody @Valid OfficialProvider officialProvider){
