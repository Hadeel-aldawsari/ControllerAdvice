...
public class RentalPackageRequestController {
    ...
    public ResponseEntity createPackageRequest(@RequestBody @Valid RentalPackageRequest  rentalPackageRequest){
    ...
    public ResponseEntity updatePackageRequest(@PathVariable Integer id,@RequestBody @Valid RentalPackageRequest rentalPackageRequest){
