...
public class PackageClassificationController {
    ...
    @PostMapping("/add")
    public ResponseEntity add(@RequestBody @Valid PackageClassification packageClassification){
    ...
    public ResponseEntity update(@PathVariable Integer id,@RequestBody @Valid PackageClassification packageClassification){
