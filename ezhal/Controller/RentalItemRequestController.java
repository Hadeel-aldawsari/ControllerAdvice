...
@RequestMapping("/api/v1/rental-item")
 public class RentalItemRequestController {
    ...
    public ResponseEntity createRequest(@RequestBody @Valid RentalItemRequest rentalItemRequest){
    ...
    public ResponseEntity update(@PathVariable Integer id,@RequestBody @Valid RentalItemRequest rentalItemRequest){
